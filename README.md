...
[![Deploy to Cloudflare](https://deploy.workers.cloudflare.com/button)](https://deploy.workers.cloudflare.com/?url=https://github.com/cloudflare/templates/tree/main/blue-cherry-a92d)
...
```
npm create cloudflare@latest -- --template=cloudflare/templates/blue-cherry-a92d
```

A live public deployment of this template is available at [https://blue-cherry-a92d.templates.workers.dev](https://blue-cherry-a92d.templates.workers.dev)
